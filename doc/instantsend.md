...
This mechanism has been integrated into Bitcore-Node-Sucr which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/sucrpay/insight-api-sucr#web-socket-api](https://github.com/sucrpay/insight-api-sucr#web-socket-api)
* API: [https://github.com/sucrpay/insight-api-sucr#instantsend-transactions](https://github.com/sucrpay/insight-api-sucr#instantsend-transactions)
...
By default, the Sucr Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Sucr Core daemon:
