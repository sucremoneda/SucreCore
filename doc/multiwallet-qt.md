...
Only requiring some minor changes is sucr.cpp.
...
Changes to sucr.cpp
----------------------
sucr.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
