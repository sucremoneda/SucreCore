...
//
// The Masternode Class. For managing the Darksend process. It contains the input of the 1000SUC, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 1000 SUCR - checking if valid masternode)
