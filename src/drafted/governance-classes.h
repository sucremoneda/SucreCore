 ...
 *
 *   // network
 *   CSucrNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.sucr.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSucrNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: SucrNetwork
// //   -- signature requirements : Key1(User)
// class CSucrNetworkVariable : public CGovernanceObject
// {
// private:
