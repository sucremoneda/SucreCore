...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SucrNetwork") type = SucrNetwork;
    if(strType == "SucrNetworkVariable") type = SucrNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SucrNetwork) s = "SucrNetwork";
    if(type == SucrNetworkVariable) s = "SucrNetworkVariable";
