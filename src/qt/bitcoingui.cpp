    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Sucr Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Sucr address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sucr: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Sucr Core"), this);
    aboutAction->setStatusTip(tr("Show information about Sucr Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Sucr Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Sucr addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Sucr addresses"));
    ...
    openAction->setStatusTip(tr("Open a sucr: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Sucr Core help message to get a list with possible Sucr Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Sucr Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Sucr network", "", count));
    } else {
...
{
    QString strTitle = tr("Sucr Core"); // default title
