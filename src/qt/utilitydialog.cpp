    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Sucr Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Sucr Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  sucr-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Sucr in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SUCR, 0.1 SUCR, 1 SUCR and 10 SUCR -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://sucrpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://sucrpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Sucr Core is shutting down...") + "<br /><br />" +
