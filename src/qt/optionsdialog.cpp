    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SUCR-light"), QVariant("light"));
    ui->theme->addItem(QString("SUCR-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("SUCR-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SUCR-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SUCR-traditional"), QVariant("trad"));
